...
//
//
class WriteSequencer extends uvm_sequencer#(axi_transaction#(DW1,AW1));
  //Register to Factory
...
//
//
class ReadSequencer extends uvm_sequencer#(axi_transaction#(DW1,AW1));
  //Register to Factory
...
//
//
class ResetSequencer extends uvm_sequencer#(axi_transaction#(DW1,AW1));
  //Register to Factory
